...
export const productionOrdersReport: RegisteredReport = {
  definition: {
    ...
    columns: [
      ...
      { key: 'plan_code', label: 'Plan', type: 'text' },
      { key: 'so_code', label: 'SO/JWSO', type: 'text' },
      ...
      { key: 'finished_qty', label: 'Finished qty', type: 'number' },
      { key: 'status', label: 'Status', type: 'text' },
      { key: 'closed_at', label: 'Closed on', type: 'datetime' },
