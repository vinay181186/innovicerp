...
export const designProjectSummaryReport: RegisteredReport = {
  definition: {
    ...
    columns: [
      ...
      { key: 'client', label: 'Customer', type: 'text' },
      { key: 'status', label: 'Project Status', type: 'text' },
      { key: 'lead', label: 'Project Lead', type: 'text' },
      { key: 'tasks', label: 'Tasks (Done / Total)', type: 'text' },
      { key: 'progress_pct', label: 'Progress %', type: 'text' },
      { key: 'open_issues', label: 'Open Issues', type: 'number' },
      { key: 'checklist', label: 'Checklist (Done / Total)', type: 'text' },
