...
describe('dashboard routes', () => {
  ...
  it('GET /dashboard/kpis returns 401 without auth', async () => {
    app = await buildApp(null);
    const res = await app.inject({ method: 'GET', url: '/dashboard/kpis' });
    expect(res.statusCode).toBe(401);
  });

  it('GET /dashboard/kpis returns 200 + tiles array for any role (incl. viewer)', async () => {
