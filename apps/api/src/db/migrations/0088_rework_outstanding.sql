-- 0088 — Rework counts DOWN. Outstanding rework is derived from the NC that
-- ordered it, not from a counter that only ever goes up.
--
-- Second defect from the IN-JC-26-00085 audit (ADR-111 §Open item 2).
