...
import { qcHistoryRoutes } from './modules/qc-history/routes';
import { capaRoutes } from './modules/capa/routes';
import { tpiRoutes } from './modules/tpi/routes';
import { reportTypesRoutes } from './modules/report-types/routes';
import { soQcStatusRoutes } from './modules/so-qc-status/routes';
...
import { printTemplatesRoutes } from './modules/print-templates/routes';
...
import { docNumbersRoutes } from './modules/doc-numbers/routes';
...
import { ospWipRoutes } from './modules/osp-wip/routes';
...
import { prodSoListRoutes } from './modules/prod-so-list/routes';
import { prodJwListRoutes } from './modules/prod-jw-list/routes';
import { dailyReportRoutes } from './modules/daily-report/routes';
import { jcOpsRoutes } from './modules/jc-ops/routes';
import { shopFloorRoutes } from './modules/shop-floor/routes';
import { jobQueueRoutes } from './modules/job-queue/routes';
import { productionScheduleRoutes } from './modules/production-schedule/routes';
...
await app.register(ospWipRoutes);
...
await app.register(prodSoListRoutes);
await app.register(prodJwListRoutes);
await app.register(dailyReportRoutes);
await app.register(jcOpsRoutes);
await app.register(shopFloorRoutes);
...
await app.register(tpiRoutes);
await app.register(reportTypesRoutes);
await app.register(soQcStatusRoutes);
...
await app.register(printTemplatesRoutes);
await app.register(costCentersRoutes);
await app.register(usersRoutes);
await app.register(companiesRoutes);
await app.register(accessControlRoutes);
await app.register(approvalConfigRoutes);
await app.register(opLogViewerRoutes);
