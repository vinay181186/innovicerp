...
export function printRouteCard(args: {
  ...
  const body = `
    ...
    <table><thead><tr><th>Op</th><th>Planned Machine</th><th>Operation</th><th>Cycle Time (h)</th><th>Program No.</th><th>Tool No.</th><th>Tool Details / Setup Notes</th></tr></thead>
