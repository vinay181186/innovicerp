...
export const DASHBOARD_WIDGETS: readonly DashboardWidgetDef[] = [
  ...
  { key: 'jc_status', label: 'Job Card Status', desc: 'Open, In Progress, Completed counts', icon: '📝', color: '#06B6D4', dept: 'production', navPage: '/job-cards' },
  { key: 'running_machines', label: 'Running Machines', desc: 'Active machines with current job', icon: '🏭', color: '#06B6D4', dept: 'production', navPage: '/production-dashboard' },
  ...
  { key: 'grn_pending', label: 'GRN QC Pending', desc: 'GRNs waiting for QC', icon: '📥', color: '#F59E0B', dept: 'store', navPage: '/goods-receipt-notes' },
  { key: 'daily_quick', label: 'Daily Task Report', desc: 'Quick link to Daily Task Reports', icon: '📝', color: '#7C3AED', dept: 'tasks', navPage: '/daily-task-reports' },
...
export const DASHBOARD_QUICK_LINKS: readonly DashboardQuickLinkDef[] = [
  { page: '/sales-orders', label: 'SO Master', icon: '📦', color: '#22C55E', dept: 'sales' },
  { page: '/so-overview', label: 'SO Overview', icon: '📊', color: '#8B5CF6', dept: 'planning' },
  { page: '/so-status', label: 'SO Status Detail', icon: '📊', color: '#8B5CF6', dept: 'planning' },
  { page: '/assemblies', label: 'Assembly Tracker', icon: '📦', color: '#14b8a6', dept: 'planning' },
  { page: '/planning', label: 'SO/JWSO Planning', icon: '📋', color: '#8B5CF6', dept: 'planning' },
  ...
  { page: '/qc-call-register', label: 'QC Call Register', icon: '🔬', color: '#EF4444', dept: 'qc' },
  { page: '/incoming-qc', label: 'Incoming QC', icon: '🔬', color: '#EF4444', dept: 'qc' },
  { page: '/qc-docs', label: 'QC Documents', icon: '🗃', color: '#EF4444', dept: 'qc' },
  ...
  { page: '/bom-masters', label: 'BOM Master', icon: '📄', color: '#8B5CF6', dept: 'design' },
  { page: '/route-cards', label: 'Route Card Master', icon: '📄', color: '#8B5CF6', dept: 'design' },
  ...
  { page: '/design-work-log', label: 'Design Work Log', icon: '⏱️', color: '#8B5CF6', dept: 'design' },
  ...
  { page: '/cost-centers', label: 'Cost Centre Master', icon: '🏢', color: '#0D9488', dept: 'finance' },
  ...
  { page: '/daily-task-reports', label: 'Daily Task Reports', icon: '📝', color: '#7C3AED', dept: 'tasks' },
  { page: '/job-work-orders', label: 'JWSO Master', icon: '📦', color: '#22C55E', dept: 'sales' },
  { page: '/clients', label: 'Customer Master', icon: '🧑', color: '#22C55E', dept: 'sales' },
  { page: '/customer-dispatches', label: 'Customer Dispatch', icon: '🚚', color: '#22C55E', dept: 'sales' },
] as const;
