...
describe('transformQcProcesses', () => {
    ...
    const result = transformQcProcesses([
      {
        id: '1olhiafn',
        name: 'MIR',
        description: 'Material Identification Report',
        defaultCycleTime: 0,
        status: 'Active',
      },
      {
        id: 'l3hbf23s',
        name: 'MCR',
        description: 'Material Clearance Report',
        defaultCycleTime: 0,
        status: 'Active',
      },
      {
        id: '5ksvw3uz',
        name: 'DIR',
        description: 'Dimensional Inspection Report (Internal Inspection)',
        defaultCycleTime: 0,
        status: 'Active',
      },
      {
      ...
      },
      {
        id: '4p3re6a7',
        name: 'TPI',
        description: 'Client Inspection Report',
        defaultCycleTime: 0,
        status: 'Active',
      },
    ]);
  ...
  it('non-Active status flips isActive=false and logs status_inactive anomaly', () => {
    const result = transformQcProcesses([{ id: 'x', name: 'Retired QC', status: 'Inactive' }]);
